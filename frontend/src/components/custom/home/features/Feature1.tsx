...
const feature1Data = [
  {
    ...
    description:
      "Easily connect with expert freelancers to gather detailed insights on your products.",
  ...
  },
  {
    ...
    description:
      "Choose from various feedback types, including text, video, website evaluations, and gaming feedback tailored to your product's needs.",
  ...
  },
  {
    ...
    description:
      "Utilize the feedback received to refine product quality and enhance user experience effectively.",
  ...
  },
  {
    ...
    title: "Hire Feeders",
    description:
      "Hire specialized feeders to gain critical perspectives that refine your product and enhance user engagement!",
...
const Feature1 = () => {
  ...
  return (
    <div className=" flex justify-center w-[100%] items-center gap-[2rem] ">
      <div className=" w-[40%] flex flex-col gap-[2rem]  ml-[5rem]">
        <div>
          <h2 className=" font-raleway font-[600] text-white/80 text-[2rem] ">
            Empowering Companies with High Quality Feedback
          </h2>
        </div>
        <div className=" flex flex-col gap-[1rem]  ">
          {feature1Data.map((feature) => {
            return (
              <div
                key={feature.id}
      ...
      <div className=" w-[60%] ">
        <CustomImage
          src={assets.image.Feature1Image}
          alt="feature-1"
          width={500}
          height={500}
